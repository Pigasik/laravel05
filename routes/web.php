...
//            }
//        $use = 'USD';
//        $key = array_search($use, $curs_name);
//        if(in_array($use, $curs_name)){
//            $curs_name = $use;
//            $value = $value[$key];
//        }
//        dd($currencies);
...
//    App::setLocale('ru');
//     dd(__('welcome.welcome-text', ['name' => 'Amigo']));
...
Route::get('/weather', function(Request $request){
        ...
        // $job = new FirstJob('rrrrrr');
        // $job->dispatch('rrrrrrr');

        //FirstJob::dispatch('rtyuio');
